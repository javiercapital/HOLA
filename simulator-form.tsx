                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        {...field}
                        rows={3}
                        placeholder="Descripción de la actividad empresarial, sector, experiencia..."
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        {...field}
                        rows={3}
                        placeholder="Detalle específico del uso de los recursos obtenidos..."
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea
                        {...field}
                        rows={3}
                        placeholder="Información sobre el contexto de mercado y oportunidades..."
                      />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
